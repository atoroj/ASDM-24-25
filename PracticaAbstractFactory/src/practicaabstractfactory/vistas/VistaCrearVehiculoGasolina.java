 ...
 * @author Antonio
 */
public class VistaCrearVehiculoGasolina extends javax.swing.JDialog {
     ...
     */
    public VistaCrearVehiculoGasolina(java.awt.Frame parent, boolean modal, ArrayList<Ford> ford, ArrayList<Toyota> toyota, ArrayList<Seat> seat) {
        super(parent, modal);
        initComponents();
        this.ford = ford;
        this.toyota = toyota;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear vehiculo gasolina:");
    ...
    private void anadirCocheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anadirCocheActionPerformed
       try {
            ...
            switch (marca) {
                case "Ford":
                    Ford nuevoFord = fabricaGasolina.creaFord(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    ford.add(nuevoFord);
                    break;
                case "Toyota":
                    Toyota nuevoToyota = fabricaGasolina.creaToyota(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    toyota.add(nuevoToyota);
                    break;
                case "Seat":
                    Seat nuevoSeat = fabricaGasolina.creaSeat(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    seat.add(nuevoSeat);
                    break;
            }

            javax.swing.JOptionPane.showMessageDialog(this, "Vehículo gasolina añadido correctamente.");
            this.dispose();
