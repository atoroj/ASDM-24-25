...
public class VistaCrearVehiculoDiesel extends javax.swing.JDialog {
     ...
     */
    public VistaCrearVehiculoDiesel(java.awt.Frame parent, boolean modal, ArrayList<Ford> ford, ArrayList<Toyota> toyota, ArrayList<Seat> seat) {
        super(parent, modal);
        initComponents();
        this.ford = ford;
        this.toyota = toyota;
    ...
    private void anadirCocheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anadirCocheActionPerformed
        try {
            ...
            switch (marca) {
                case "Ford":
                    Ford nuevoFord = fabricaDiesel.creaFord(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    ford.add(nuevoFord);
                    break;
                case "Toyota":
                    Toyota nuevoToyota = fabricaDiesel.creaToyota(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    toyota.add(nuevoToyota);
                    break;
                case "Seat":
                    Seat nuevoSeat = fabricaDiesel.creaSeat(modelo, tipo, cv, consumo, -1, -1, plazas, precio, cc);
                    seat.add(nuevoSeat);
                    break;
            }
