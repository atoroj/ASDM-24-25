...
public abstract class Seat {
    ...
    //Gasolina-Diesel
    public Seat(String modelo, String tipo, int cv, int consumo, int plazas, float precio, float cc) {
        this.modelo = modelo;
        this.tipo = tipo;
        this.cv = cv;
    ...
    public Seat(String modelo, String tipo, int cv, int autonomiaElectrica, int recarga, int plazas, float precio) {
        this.modelo = modelo;
        this.tipo = tipo;
        this.cv = cv;
    ...
    public Seat(String modelo, String tipo, int cv, int consumo, int autonomiaElectrica, int plazas, float precio, float cc) {
        this.modelo = modelo;
        this.tipo = tipo;
        this.cv = cv;
        this.consumo = consumo;
